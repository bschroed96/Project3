...
hitInfo rayCircleIntersect(Vec2 center, // Center of obstacle
                           float r,     // radius of obstacle
                           Vec2 l_start,  // start of line segment
                           Vec2 l_dir,    // normalized direction of line
                           float max_t){ // the length of the line
  hitInfo hit = new hitInfo();
